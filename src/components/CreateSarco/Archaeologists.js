...
const ArcInfoBox = ({archaeologist, handleSelected, handleSelect, selected}) => (
...
const ArchaeologistList = ({ handleSelected, archSelected }) => {
  ...
  return archaeologists.map((archaeologist) => <ArcInfoBox key={archaeologist.archaeologist} handleSelected={handleSelected} archaeologist={archaeologist} handleSelect={_handleSelect} selected={selected}/>)
}

const base = "w-full bg-white text-gray-900 mt-6 mb-4"
const disabled = "w-full bg-gray-400 text-gray-900 mt-6 mb-4"

const Archaeologists = ({ handleSelected, selected, handleEmbalming, setExpanded, setCompleted }) => (
  <div className="relative w-full h-full px-4"> 
    <Title title="Archaeologists" />
    <ArchaeologistList handleSelected={handleSelected} archSelected={selected}/>
