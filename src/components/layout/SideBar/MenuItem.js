...
const ClosedButton = ({ handleClick, label }) => (
  <div className="border border-white my-2 py-1 text-center cursor-pointer" onClick={handleClick} style={{ height: '2rem', minWidth: '22rem' }}>
    { label }
  </div>
)

const ExpandedButton = ({ handleClick, children }) => (
  <div className="border border-white my-2 p-2 relative" style={{ minWidth: '22rem' }}>
